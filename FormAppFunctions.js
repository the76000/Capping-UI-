...
function enableRefAgencyOtherBox(){
 ...
 function houseHoldTableEvent(){
	...
	cell8.innerHTML = '<input type="text" size="20" maxlength="75" id="hComment" name="hComment[]" class="form-control"><span class="glyphicon glyphicon-plus" onclick="houseHoldTableEvent();"></span><span class="glyphicon glyphicon-minus" onclick="removeRow(this,\'houseHoldTable\')"></span>';
 }
