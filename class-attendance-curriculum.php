...
<head>
	...
	<title> CPCA Class Attendance </title>
	...
	<nav class="navbar navbar-default CPCA_navbar">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Class Attendance</a>
			</div>
...
echo			'<form onsubmit="return validateInput()" action="class-attendance-curriculum.php" method="post">';
...
echo 				'<table class = "table">';
						...
						foreach ($line as $fnamevalue ) { //display all of the arrays
							...
							echo "</td>";
							echo "<td>";
							echo "<form action = 'class-attendance-submitted.php' method='post'>";
