...
<form class="form-inline" action="ReferralInsertRecord.php" method="post">
<br>
...
<textarea id="RefReason" name="RefReason" class="form-control" style="resize:none;width:100%;" maxlength="250"> </textarea>
...
<table width="100%" id="houseHoldTable">
	...
	<tr>
		...
		<td><input type="text" size="20" maxlength="75" id="hComment" name="hComment[]" class="form-control"><span class="glyphicon glyphicon-plus" onclick="houseHoldTableEvent();"></span><span class="glyphicon glyphicon-minus" onclick="removeRow(this,'houseHoldTable');"></span></td>
	</tr>	
</table>
...
<textarea id="addInfoSpecNeeds" name="addInfoSpecNeeds" class="form-control" style="resize:none;width:100%;" maxlength="250"> </textarea>
...
<textarea id="Comments" name="Comments" class="form-control" style="resize:none;width:100%;" maxlength="250"> </textarea>
